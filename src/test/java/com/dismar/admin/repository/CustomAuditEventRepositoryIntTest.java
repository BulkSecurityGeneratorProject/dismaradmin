...
import com.dismar.admin.config.audit.AuditEventConverter;
import com.dismar.admin.domain.PersistentAuditEvent;
...
import static com.dismar.admin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
