package com.dismar.admin.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.dismar.admin.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.dismar.admin.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
